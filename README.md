...
- William Faulkner (about Ernest Hemingway) According to [Arthur Byrne]

**"Poor Faulkner. Does he really think big emotions come from big words?"** [Good Reads]

- Ernest Hemingway (about William Faulkner)

## GabbyOS.neocities.org
...
- Coded with HTML | CSS *styling* and *animations* | *vanilla* Javascript
  - Assembled in VS-Code and Pushed to a [Github] **Repository**
...
(note: this is currently not proper markdown format and will be edited in the future for consistency | FIXME**)

- <a /target="_blank" href="<https://icons8.com/icon/B95fU1QGwW27/home>">Home</a> icon by <a /target="_blank" href="<https://icons8.com>">Icons8</a>
- Favicon from <https://Favicon.cc>
- Footer background image is Snowy-Slumber-2024 from Steam

*Additional blinkies, sidebar buttons and backgrounds found on the Word Wide Web.*
...
- Name: Gabrielle Saab
- Location: Metro DTE \- CLE

## Contact

\[GitHub\]: [github.com/Gab91s](https://github.com/Gab91s)  
\[LinkedIn\]: [www.linkedin.com/in/gabrielle-saab](https://www.linkedin.com/in/gabrielle-saab)  
\[X\]: [x.com/saab2010](https://x.com/saab2010)
